...
import ProjectSearchTag from '../Components/ItemContents/ProjectTag';
import ImgUploader from '../Components/ItemContents/ImgUploader';
...
import ProjectHandleDate from '../Components/ItemContents/ProjectHandleDate';
        ...
        contents: [
          {
            ...
            inputComponent: (
              <ProjectHandleDate text="시작" stateName="launch_date" />
            ),
          },
          {
            id: 2,
            ...
            inputComponent: (
              <ProjectHandleDate text="마감" stateName="end_date" />
            ),
          },
        ],
      },
